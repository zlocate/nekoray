...
pkgname='nekoray-git-without-ads'
pkgver=3.25.r3.g894410d
pkgrel=1
pkgdesc='Fork of Qt based cross-platform GUI proxy configuration manager (backend: v2ray / sing-box) without ads'
arch=('x86_64')
url='https://github.com/zlocate/nekoray'
license=('GPL')
...
source=(
	'git+https://github.com/zlocate/nekoray.git'
	'nekoray.desktop'
)
